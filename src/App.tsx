...
const App: React.FC = () => {
  ...
  return <div className="app-shell font-sans">
    ...
    {error && <div role="status" aria-live="polite" className="mt-5 rounded-[14px] border-2 border-[#df3d48] bg-[#fff0f0] p-4 text-sm font-bold text-[#a51e2a]"><strong>Backend unavailable</strong><p className="mt-1 mb-0 font-semibold">The server may be waking from a cold start. The match list will retry automatically.</p></div>}
